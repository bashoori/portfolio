...
<div style="background:linear-gradient(180deg, #f7fafc 0%, #edf3f8 100%);padding:40px 20px;">

  <!-- ====== Content Container ====== -->
  <div style="max-width:1100px;margin:0 auto;background:#ffffff;padding:36px 32px;border-radius:20px;box-shadow:0 14px 36px rgba(15,23,42,0.08);border:1px solid #e8eef5;">

    <!-- ====== Header ====== -->
    <div style="display:flex;align-items:center;justify-content:space-between;gap:36px;flex-wrap:wrap;padding-bottom:28px;border-bottom:1px solid #e8eef5;">
      ...
      <div style="flex-shrink:0;">
        <div style="width:190px;height:190px;border-radius:50%;overflow:hidden;border:4px solid #f8fafc;box-shadow:0 10px 24px rgba(15,23,42,0.12);background:#fff;">
          <img
    ...
    <!-- ====== Current Focus ====== -->
    <div style="margin-top:28px;background:linear-gradient(180deg, #f9fbff 0%, #f3f7fc 100%);border:1px solid #e3ebf5;border-radius:16px;padding:22px 24px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:16px;margin-top:22px;">
      <div style="background:#ffffff;border:1px solid #e6edf5;border-radius:14px;padding:18px 20px;box-shadow:0 4px 14px rgba(15,23,42,0.04);">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:18px;margin-top:14px;">
      ...
      <div style="background:#f9fbff;border:1px solid #e3ebf5;border-radius:16px;padding:22px 20px;box-shadow:0 6px 18px rgba(15,23,42,0.04);">
    ...
    <div style="display:grid;grid-template-columns:minmax(0,1.45fr) minmax(280px,0.95fr);gap:22px;align-items:stretch;margin-top:14px;">

      <!-- ====== TransLink Project ====== -->
      <div style="background:#f9fbff;border:1px solid #e3ebf5;border-radius:18px;padding:24px;box-shadow:0 8px 22px rgba(15,23,42,0.05);">
        ...
        <p style="color:#64748b;line-height:1.8;margin:0 0 16px;">
          ...
          🔗 <a href="https://github.com/bashoori/transit_data_warehouse" style="color:#2563eb;font-weight:600;text-decoration:none;">View on GitHub</a>
        </p>
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div style="background:#ffffff;border:1px solid #e3ebf5;border-radius:16px;padding:18px 20px;box-shadow:0 8px 22px rgba(15,23,42,0.05);">
    ...
    <!-- ====== Footer ====== -->
    <div style="margin-top:38px;padding-top:18px;border-top:1px solid #e8eef5;display:flex;justify-content:space-between;flex-wrap:wrap;gap:16px;align-items:center;">
